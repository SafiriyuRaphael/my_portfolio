            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              {[1, 2, 3].map((ring, idx) => (
                <motion.div
                  ...
                  style={{ 
                    width: `${85 - idx * 15}%`, 
                    height: `${85 - idx * 15}%`,
                    borderColor: idx === 0 ? '#fca311' : idx === 1 ? '#2A9D8F' : '#E76F51',
                    borderWidth: 1
                  }}
                  animate={{ 
                    rotate: 360,
              ...
              {[0, 1, 2].map((dot, idx) => (
                <motion.div
                  ...
                  style={{ 
                    backgroundColor: dot === 0 ? '#fca311' : dot === 1 ? '#2A9D8F' : '#E76F51',
                    boxShadow: `0 0 10px ${dot === 0 ? '#fca311' : dot === 1 ? '#2A9D8F' : '#E76F51'}`
                  }}
                  animate={{ 
                    pathOffset: [0, 1],
                    transition: { 
              ...
              >
                ...
                {[
                  ...
                  >
                    ...
                    <div className="text-xs text-[#fca311] whitespace-nowrap">{point.label}</div>
                  </motion.div>
                ))}
              </motion.div>
            </div>

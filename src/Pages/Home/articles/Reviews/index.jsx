          ...
          <div className="relative mb-8">
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  "inset 0 0 30px rgba(0,0,0,0.6), 0 0 30px rgba(79, 70, 229, 0.4)",
              }}
        ...
        <div className="flex justify-center mt-8 gap-2">
          {reviews.map((_, idx) => (
            <motion.button
              ...
              initial={{ opacity: 1, scale: 0, y: 10 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ delay: 0.1 * idx + 1.2 }}
            >
              <motion.div
                className={`w-3 h-3 rounded-full ${
                  activeIndex === idx ? "bg-blue-500" : "bg-slate-600/50"
                }`}
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <motion.div className="absolute top-0 left-0 w-20 h-full bg-white/20 skew-x-12 -translate-x-32 group-hover:translate-x-[400px] transition-transform duration-1000" />
            </a>
          </motion.div>
        </motion.div>
      </div>

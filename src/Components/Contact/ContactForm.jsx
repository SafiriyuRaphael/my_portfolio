...
const ContactForm = () => {
    ...
    >
      ...
      <input
        ...
        name='firstName'
        required
        className="m-4 border-b-2 border-[#b5179e] focus:outline-none focus:border-b-8 "
      />
      ...
      <textarea
        placeholder="Message"
        className="m-4 border-b-2 border-[#b5179e] focus:outline-none focus:border-b-8  w-full h-24"
        required
        name='message'
      />
      <br />

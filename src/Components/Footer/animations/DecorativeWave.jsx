      ...
      >
        <defs>
          ...
          <linearGradient id="waveGradient1" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="50%" stopColor={`${theme.accent || theme.primary}25`} />
          ...
          <linearGradient id="waveGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="66%" stopColor={`${theme.accent || theme.primary}20`} />
            <stop offset="100%" stopColor={`${theme.secondary}20`} />
          </linearGradient>
          
          <linearGradient id="waveGradient3" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor={`${theme.accent || theme.primary}15`} />
            <stop offset="50%" stopColor={`${theme.secondary}15`} />
            <stop offset="100%" stopColor={`${theme.accent || theme.primary}15`} />
          </linearGradient>

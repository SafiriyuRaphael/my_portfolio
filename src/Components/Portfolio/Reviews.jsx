...
const reviews = [
  ...
  { text: "Remarkably creative and professional. Our collaboration was both enjoyable and highly productive.", client: "Collin Davis", position: "UX Designer", image: "/client/client5.jpg", },
  {
   ...
   { text: "Outstanding attention to detail and an ability to deliver top-notch results on time. Truly impressive.", client: "Robert Martinez", position: "Data Scientist", image: "/client/client6.jpg"
  }]
      ...
      <div className="relative">
        ...
        >
          {reviews.map((item, index) => (
            ...
            >
              <div className="size-32 rounded-full mb-4"
              style={{
